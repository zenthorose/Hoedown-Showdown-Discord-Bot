...
const { MaleEmoji, MaleName, Hoedown_New_bannerEmoji, FemaleName } = require('../config.json');
...
module.exports = {
    ...
    async execute(interaction, reactionPostsManager) {
        ...
        await message.react(Hoedown_New_bannerEmoji);
